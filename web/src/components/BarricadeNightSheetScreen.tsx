...
import barricadeBoard from '../assets/barricade/barricade-board.png'
 ...
 * stub (see worker/src/families/teamwork.ts): two static Figma exports
 * stand in for real gameplay art until the tracker board's own mechanic
 * (knife/kit/board resources) is designed. Same 3-region proportional
 * layout as BattleNightSheetScreen (SheetFrame/CoinFrame/ScoreFrame —
 * 469/144/152 out of 765, Figma's own NightScreen_iPhone split, shared by
 * every Sheet style so a viewer's eye doesn't jump switching Sheets) — but
 * CoinFrame and ScoreFrame reuse their generic components completely as-is:
 * a static idle CoinRow (4 slots, no flips — Barricade's own coin count per
 * Josh's plan) and NightSheetFooter unchanged, since none of its fields are
 * Family-specific.
 *
 * SheetFrame stacks the two images at their own real Figma proportions
 * (BarricadeScene 311/477, BarricadeBoard 166/477 — node 83:129) with the
 ...
 * Figma (BarricadeBoard doesn't); the border is drawn by this wrapper, not
    ...
    <div className="flex h-full w-full flex-col">
      <div className="flex min-h-0 flex-[469] flex-col">
        ...
        <div className="flex min-h-0 flex-[166] items-center justify-center">
          <img src={barricadeBoard} alt="" className="h-full w-full object-contain" />
        </div>
      </div>
